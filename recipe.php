    ...
    <section>
    	<div class="container">
					...
					<form id="searchProduct" method="GET">
						<div class="row">
							...
							<div class="col-md-8">
								...
								<div class="form-group">
									<input type="text" name="keyword" class="form-control keyword" placeholder="Recipe name...">
								</div>
							</div>
							<div class="col-md-4">
								<label for=""></label>
    		...
    		<div class="row align-items-end">
				<?php
				$s = "SELECT *, s.business_title FROM tbl_recipe r LEFT JOIN tbl_seller s ON r.u_id=s.user_id WHERE r.r_is_active=1";
				$r = $c->fetchData($pdo, $s);
				if($r){
					foreach($r as $row){
						?>
