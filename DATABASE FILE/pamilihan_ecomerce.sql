...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2025 at 08:03 AM
...
(3, 3, 'Pork Chop', '150', '125', 0, 0, 20, 12, '', '', 0, 'product-featured-3.jpg', '', '<p>1kg</p>', '', '', '', 8, 1, 1, 0),
(4, 3, 'Guava', '150', '125', 0, 0, 20, 12, '', '', 0, 'product-featured-4.jpg', '', '<p>1kg</p>', '', '', '', 141, 1, 1, 0),
(13, 3, 'Fresh Beef Brisket', '249', '', 0, 0, 20, 12, '', '', 0, 'product-featured-13.jpg', '', '', '', '', '', 207, 1, 1, 0);
...
INSERT INTO `tbl_purchase_order` (`id`, `order_id`, `customer_id`, `rider_id`, `remarks`, `date_and_time`, `status`) VALUES
(1, 'OW62PFLFR54', 5, '6', 'Completed', '1737103020', 'Completed'),
(2, 'OMSGXZV3RMC', 5, '6', 'Completed', '1737269465', 'Completed');
...
(1, 3, 'Sinigang', '<p>Step 1:</p><ul><li>For Step 1</li></ul><p>Step 2:</p><ul><li>For Step 2</li></ul>', '119', 'recipe-featured-1.jpg', 1);
...
(1, 4, 'Example Cust', '09345789782', 'Philippines', 'asdasda', 'Taguig', '', ''),
(2, 5, 'Example Customer', '0987654321', 'Philippines', 'East Service Road, San Martin de Porres, Parañaque District 2, Parañaque, Southern Manila District, Metro Manila, 1700, Philippines', 'Taguig', '14.4668709', '121.0456823');
...
(1, 'Erick Matte', 'admin@gmail.com', '099999878', '0192023a7bbd73250516f069df18b500', 'user-11.jpeg', 'Admin', 'Active'),
(2, 'Asdasdas asds', 'rider1@gmail.com', '09819273819', '4297f44b13955235245b2497399d7a93', NULL, 'Rider', 'Active'),
(3, 'asdasdas', 'seller1@gmail.com', '0891723861', 'a8f5f167f44f4964e6c998dee827110c', 'user-user.png', 'Seller', 'Verified'),
(4, 'Adsad asdasdsa', 'customer1@gmail.com', '09218759834', '4297f44b13955235245b2497399d7a93', NULL, 'customer', 'Active'),
(5, 'Example Customer', 'example@gmail.com', '0978293452', '4297f44b13955235245b2497399d7a93', NULL, 'customer', 'Active'),
(6, 'New Rider', 'rider@gmail.com', '09428739472', '4297f44b13955235245b2497399d7a93', NULL, 'Rider', 'Active');
