...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {    	
		...
		$statement = $pdo->prepare("UPDATE tbl_size SET size_name=?, size_value=? WHERE size_id=?");
		$statement->execute(array($_POST['size_name'], $_POST['size_value'], $_REQUEST['id']));
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
				...
				<div class="form-group">
					<label for="" class="col-sm-2 control-label">Size Value <span>*</span></label>
					<div class="col-sm-4">
						<input type="text" class="form-control" name="size_value" value="<?= $size_value; ?>">
						<small><b>Example: </b>Product Price / <b>8</b> (Size Value is 8)</small>
					</div>
				</div>
                <div class="form-group">
